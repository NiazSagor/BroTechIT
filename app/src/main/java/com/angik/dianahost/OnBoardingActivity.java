...
public class OnBoardingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PaperOnboardingPage scr1 = new PaperOnboardingPage("Web Hosting",
                "We provide the best hosting",
                Color.parseColor("#29a6de"), R.drawable.ic_web_main, R.drawable.ic_web_outline);
        PaperOnboardingPage scr2 = new PaperOnboardingPage("Instant Activation",
                "Easy setup with instant activation",
                Color.parseColor("#ffd699"), R.drawable.ic_setup_main, R.drawable.ic_setup_outline);
        PaperOnboardingPage scr3 = new PaperOnboardingPage("Affordable Pricing",
